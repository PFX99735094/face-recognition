...
class App(ctk.CTk):
    def __init__(self):
        ...
        # --- Conexão Serial ---
        self.arduino = None
        arduino_port = 'COM7'  # Mude para a porta do seu Arduino!
        baud_rate = 9600
        try:
    ...
    # --- NOVO: Função para limpar os widgets de um frame ---
    ...
    def start_capture_mode(self):
        self._clear_frame_widgets(self.capture_frame)  # Limpa widgets antigos
    ...
    def start_recognition_mode(self):
        self._clear_frame_widgets(self.recognize_frame)  # Limpa widgets antigos
        self.main_frame.pack_forget()
    ...
    # --- 5. Lógica da Câmera e Comunicação Serial ---
