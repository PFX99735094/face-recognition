...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.after_id = None
        self.photo_references = []  # NOVO: Armazena referências para as fotos
    ...
    def show_list_photos(self):
        ...
        self.photo_references.clear()  # NOVO: Limpa a lista de referências
        ...
        if not image_files:
            ...
            for filename in image_files:
                ...
                try:
                    ...
                    # Cria e armazena a referência da imagem
                    ...
                    ctk.CTkLabel(frame, image=self.photo_references[-1], text="").pack(side="left", padx=10)
                    ctk.CTkLabel(frame, text=filename, font=("Arial", 16)).pack(side="left", padx=10)
    ...
    # --- 6. Lógica da Câmera e Comunicação Serial ---
